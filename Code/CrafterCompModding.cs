...
namespace IngredientBuffer
{
    ...
    {
        static Type target = typeof(CrafterComp);
        ...
        [Inject(typeof(CrafterComp), "OnLateReady")]
        ...
        [InjectAttribute(typeof(CrafterComp), "OnSave")]
        ...
        [Inject(typeof(CrafterComp), "OnLoad", BindingFlags.NonPublic| BindingFlags.Instance)]
        ...
        [Inject(typeof(CrafterComp), "RebuildIngredientsReq", BindingFlags.NonPublic| BindingFlags.Instance)]
        ...
        [Inject(typeof(CrafterComp), "ProvideRequestedMat")]
        ...
        [Inject(typeof(CrafterComp), "SpawnCraftable", BindingFlags.NonPublic| BindingFlags.Instance)]
        ...
        [Inject(typeof(CrafterComp), "SwitchToCrafting")]
        ...
        [Inject(typeof(CrafterComp), "StopProducing")]
        ...
        [Inject(typeof(CrafterComp), "RelocateTo")]
...
[Inject(typeof(CrafterComp), "CheckMissingIngredients", BindingFlags.NonPublic| BindingFlags.Instance)]
